...
graduates.map((currentValue) => {
    return universities.push(currentValue.university);
  });

console.log(universities)
  
universities.sort((university1,university2) => (university1 > university2) ? 1 : -1)
...
const newCityFilter = graduates.filter((currentValue) => {
...
const popFilter = zooAnimals.filter((item ) => { return item.population < 5 })
